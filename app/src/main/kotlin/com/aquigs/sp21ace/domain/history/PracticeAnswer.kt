...
data class PracticeAnswer(
    ...
    val ruleSet: RuleSet,
    val hand: TrainerHand,
    val answer: Move,
    val correctMove: Move,
    val isCorrect: Boolean,
) {
    constructor(answeredAt: Instant, ruleSet: RuleSet, grade: Grade) :
        this(answeredAt, ruleSet, grade.hand, grade.answer, grade.correctMove, grade.isCorrect)

    /** The row of the chart square the hand is read from, beside [hand]'s upcard. Its table is the kind of hand: hard, soft or a pair. */
    val row: ChartRow = chartRow(hand.player)
}
