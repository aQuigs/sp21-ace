...
/**
 * A tab's figures over a period: a tally for every move the hands called for. [longestStreak] is the most right answers in a
 * row over every answer ever given, whatever the period and tab, as Blackjack Ace's Streak card counts.
 */
