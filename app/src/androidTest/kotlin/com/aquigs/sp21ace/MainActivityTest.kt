...
class MainActivityTest {
    ...
    fun opensOnTheStrategyTrainerWithAHandDealt() {
        ...
        compose.onNodeWithText(compose.activity.getString(R.string.dealer)).assertIsDisplayed()
        compose.onNodeWithText(compose.activity.getString(R.string.you)).assertIsDisplayed()
